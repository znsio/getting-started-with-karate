...
Feature: Create and Update User Posts
  ...
  Scenario: Create a User post and then Update its title
    * def createPost = karate.call('classpath:com/znsio/templates/createPostTemplate.feature@t_createPost', {"userId": userId, "title": title, "body": body, expectedStatus: 201})
    ...
    * def fetchPosts = karate.call('classpath:com/znsio/templates/fetchPostTemplate.feature@t_getPost', {"userId": id, expectedStatus: 200})
    ...
    * def updatePost = karate.call('classpath:com/znsio/templates/updatePostTemplate.feature@t_updatePost', {"title": newTitle, expectedStatus: 201})
